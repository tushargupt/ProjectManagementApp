...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'PROJECT_INVITE', 'COMMENT_MENTION', 'DEADLINE_APPROACHING');

-- CreateEnum
CREATE TYPE "DependencyType" AS ENUM ('FINISH_TO_START', 'FINISH_TO_FINISH', 'START_TO_START', 'START_TO_FINISH');
...
-- CreateIndex
CREATE UNIQUE INDEX "TeamMembership_userId_projectId_key" ON "TeamMembership"("userId", "projectId");
...
-- AddForeignKey
ALTER TABLE "TeamMembership" ADD CONSTRAINT "TeamMembership_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
